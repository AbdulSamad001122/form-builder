...
const PLANS = [
  {
    ...
    features: [
      ...
      "Linear step-by-step form runner",
  ...
  },
  {
    name: "Pro (Branding)",
    price: "5",
    tagline: "Total brand control & customizations",
    features: [
      "Everything in Free",
      "Custom Company Branding & Logos",
      "Direct secure Cloudinary logo uploading",
      "6 dynamic color wheels for BG & text",
      "Form response limits & expiry timers",
      "Security password gate entry protection",
      "CSV submission responses data export",
    ],
    cta: "Get Pro",
    featured: true,
  },
  {
    name: "Business (Logic)",
    price: "9",
    tagline: "Elite logic branching & workflow mapping",
    features: [
      "Everything in Pro",
      "Interactive Visual Logic Jumps Canvas",
      "Otherwise default fallback logic handle",
      "Animated curved path connection lines",
      "Dashed/solid customizable styling lines",
      "Dynamic real-time progress runner bar",
      "Archived workspaces form organizer",
    ],
    cta: "Get Business",
    featured: false,
  }
